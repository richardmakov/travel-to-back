package com.travelto.backend.config;
...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(TripRepository tripRepository, RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
    ...
    private void loadDefaultUser() {
        if (userRepository.count() == 0) {
            ...
            user.setLastname("TravelTO");
            user.setEmail("admin@travelto.com");
            user.setPassword(passwordEncoder.encode("12345678"));
            user.setPhone("666666666");
            user.setIdCard("GGGGGGG");
            user.setPassport("GGGGGGG");
            user.setCountry("Spain");
            user.setDate("2003-08-19");
